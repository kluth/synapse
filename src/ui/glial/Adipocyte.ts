...
export interface AdipocyteConfig {
  id: string;
...
/**
 * Adipocyte - Manages global UI state with time-travel debugging
 */
export class Adipocyte extends Astrocyte {
  ...
  constructor(config: AdipocyteConfig) {
    super({
      id: config.id,
      cacheSize: 1000,
      ttl: 3600000, // 1 hour
