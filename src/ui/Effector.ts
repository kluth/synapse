/**
 * Effector - Action components that trigger side effects
 * Handles API calls, navigation, state mutations, etc.
 */

import { SkinCell } from './SkinCell';
import type { Signal } from '../types';
import type { EffectorProps, EffectorState } from './types';
...
/**
 * Effector - Executes actions and side effects
 * Examples: Submit buttons, navigation links, action triggers
 */
export abstract class Effector<
  TProps extends EffectorProps = EffectorProps,
  TState extends EffectorState = EffectorState,
> extends SkinCell<TProps, TState> {
  ...
  /**
   * Connect this effector to a backend neuron
   */
