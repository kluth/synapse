...
export interface TouchReceptorProps extends ReceptorProps {
  label: string;
...
export interface TouchReceptorState extends ReceptorState {
  pressed: boolean;
  hovered: boolean;
  disabled: boolean;
}

export class TouchReceptor extends Receptor<TouchReceptorProps, TouchReceptorState> {
