...
export interface TextReceptorProps extends ReceptorProps {
...
export interface TextReceptorState extends ReceptorState {
  focused: boolean;
  value: string;
  hasError: boolean;
}

export class TextReceptor extends Receptor<TextReceptorProps, TextReceptorState> {
