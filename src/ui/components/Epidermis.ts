...
export interface CardProps extends DermalLayerProps {
  title?: string;
  subtitle?: string;
  children: string;
...
export interface CardState extends DermalLayerState {
  hovered: boolean;
  pressed: boolean;
}

export class Epidermis extends DermalLayer<CardProps, CardState> {
