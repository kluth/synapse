...
export interface TextProps extends SkinCellProps {
  children: string;
...
export interface TextState extends SkinCellState {
  hovered: boolean;
}

export class Keratinocyte extends SkinCell<TextProps, TextState> {
