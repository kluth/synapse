...
export interface AlertProps extends ReceptorProps {
  message: string;
...
export interface AlertState extends ReceptorState {
  visible: boolean;
  hovered: boolean;
}

export class AlertReceptor extends Receptor<AlertProps, AlertState> {
