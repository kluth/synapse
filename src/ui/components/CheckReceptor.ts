...
export interface CheckReceptorProps extends ReceptorProps {
  label: string;
  checked: boolean;
...
export interface CheckReceptorState extends ReceptorState {
  checked: boolean;
  focused: boolean;
  hovered: boolean;
}

export class CheckReceptor extends Receptor<CheckReceptorProps, CheckReceptorState> {
