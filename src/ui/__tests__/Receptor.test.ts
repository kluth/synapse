/**
 * Tests for Receptor (Input components)
 */
...
// Test implementation
class TestInputReceptor extends Receptor<
...
describe('Receptor', () => {
  let neuron: TestInputReceptor;
  let onChangeMock: jest.Mock;

  beforeEach(() => {
    onChangeMock = jest.fn();
    neuron = new TestInputReceptor({
      id: 'test-input',
      type: 'reflex',
      threshold: 0.3,
      props: {
  ...
  describe('Debouncing', () => {
    it('should debounce rapid input events', async () => {
      class DebouncedInput extends TestInputReceptor {
