/**
 * Tests for DermalLayer (Container/Layout components)
 */
...
class TestChild extends SkinCell<{ label: string; value: number }, { count: number }> {
...
class TestContainer extends DermalLayer<
