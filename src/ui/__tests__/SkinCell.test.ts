...
class TestSkinCell extends SkinCell<{ label: string; value: number }, { count: number }> {
...
describe('SkinCell', () => {
  let neuron: TestSkinCell;

  beforeEach(() => {
    neuron = new TestSkinCell({
      id: 'test-skin',
      type: 'cortical',
      threshold: 0.5,
  ...
  describe('Construction and Initialization', () => {
    it('should create a skin cell with props and state', () => {
      expect(neuron.id).toBe('test-skin');
  ...
  describe('Signal Processing', () => {
    ...
    it('should respect activation threshold', async () => {
      const highThresholdNeuron = new TestSkinCell({
        id: 'high-threshold',
        type: 'cortical',
        threshold: 0.9,
  ...
  describe('Refractory Period', () => {
    ...
    it('should prevent rapid sequential processing during refractory period', async () => {
      class RefractoryNeuron extends TestSkinCell {
